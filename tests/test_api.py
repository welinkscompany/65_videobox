...
def test_output_operator_copy_builder_ignores_non_dict_tracks_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
    ...
    assert "stale_track_entry" not in prompt
    assert "'track_type': 'narration'" in prompt
    assert "'clip_count': 1" in prompt


def test_output_operator_copy_builder_ignores_minimal_dict_tracks_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
    ...
    assert "'track_type': ''" not in prompt
    assert "'track_type': 'narration'" in prompt
    assert "'clip_count': 1" in prompt
...
def test_output_operator_copy_builder_trims_pending_recommendation_selected_asset_id_in_prompt() -> None:
    ...
    assert "'selected_asset_id': 'asset_tts_001'" in prompt
    assert "'selected_asset_id': ' asset_tts_001 '" not in prompt


def test_output_operator_copy_builder_trims_pending_recommendation_id_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
...
def test_output_operator_copy_builder_trims_pending_recommendation_selected_asset_uri_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
...
def test_output_operator_copy_builder_trims_review_flag_segment_id_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
...
def test_output_operator_copy_builder_defaults_review_flag_message_in_prompt() -> None:
    builder = LocalFirstOutputOperatorCopyBuilder(runtime_service=object())
...
def test_review_guidance_builder_trims_pending_recommendation_selected_asset_id_in_prompt() -> None:
    builder = LocalFirstReviewGuidanceBuilder(runtime_service=object())
...
def test_review_guidance_builder_trims_pending_recommendation_created_at_in_prompt() -> None:
    builder = LocalFirstReviewGuidanceBuilder(runtime_service=object())
