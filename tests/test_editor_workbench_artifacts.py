...
SOURCES = (
    ROOT / "apps/web/src/features/editor/workbench/EditorWorkbench.tsx",
    ROOT / "apps/web/src/features/editor/preview/preview-stage.tsx",
)
...
def test_editor_workbench_artifacts_are_deterministic_and_user_approved():
