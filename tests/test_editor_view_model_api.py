...
def test_explicit_session_manifest_has_authoritative_typed_editor_contract(tmp_path) -> None:
    ...
    assert body["captions"] == [{"segment_id": "segment-1", "owning_segment_id": "segment-1", "caption_id": "caption-segment-1-0", "placement_id": "caption:caption-segment-1-0", "text": "안녕하세요", "start_sec": 0.0, "end_sec": 2.0, "style": {"font_family": "Pretendard", "font_size_px": 48, "text_color": "#FFFFFFFF", "outline_color": "#000000FF", "outline_width_px": 3, "background_color": "#00000000", "position_x_percent": 50, "position_y_percent": 88, "horizontal_align": "center", "safe_area_enabled": True, "shadow_blur_px": 0, "bold": False, "italic": False, "letter_spacing_px": 0}}]
