    ...
    *,
    ...
    return {
        ...
        "output": {
            ...
            # 길이는 **조각을 옮길 때의 상한과 같은 자리에서** 잰다
            # (`materialized_timeline_duration_sec`). 두 곳에서 따로 세다가
            # 눈금자는 120초, 상한은 5초를 말했다(2026-09-12).
...
# 길이를 재던 `_duration_seconds`는 `composition_plan.
# materialized_timeline_duration_sec`으로 옮겼다 -- 조각을 옮길 때의 상한도 같은
# 양을 따로 세고 있었고, 둘이 어긋나 있었다(2026-09-12).
