...
### Task 31: 내보내기가 화면에서 불가능하다 — **미착수 · 최우선**
...
- [ ] **Step 0: owner 확인 (선행)** — 승인 UI를 막아둔 것이 의도적 보류인지 확인한다.
      화면 문구와 테스트 고정을 보면 **의도적**으로 보이지만, `docs/` 어디에도
      "승인 계약" 설계 문서가 없고 커밋 메시지도 한 줄뿐이라 **단정하지 않는다**
- [ ] **Step 1~: owner 확인 후 확정**
