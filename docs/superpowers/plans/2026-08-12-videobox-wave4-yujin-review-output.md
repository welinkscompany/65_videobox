...
- [ ] Complete the full real-browser reverse flow (send proposal, preview/cancel, apply once, undo/reapply) and controlled sibling render failure/retry/playback. Owner-ready Check is `pass`, but this is not owner acceptance or human sign-off.
