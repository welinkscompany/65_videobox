...
- [ ] Remaining gate: verify editor-side undo/reapply and both-variant render/playback with a controlled sibling failure/retry in a real owner runtime. The footage send/preview/cancel/resend/preview/apply path is verified above. Owner-ready Check is `pass`, but this is not owner acceptance or human sign-off.
