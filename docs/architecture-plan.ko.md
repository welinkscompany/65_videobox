...
> **현재 상태 (2026-08-09):** 아직 만들지 않았다. 전사·분석·렌더·export는 전부
> API 프로세스 안의 데몬 스레드에서 돈다. `services/worker/`에 한 줄짜리
> placeholder가 있었지만 어디에도 등록돼 있지 않아 지웠다 — 워커가 있다는
> 잘못된 신호만 주고 있었다. 이 절은 계획으로 남긴다.
