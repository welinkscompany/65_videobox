...
> **대체됨(2026-09-08):** 이 문서 §2의 순서를 다음 세션이 전부 고쳤다. 결과는
> `docs/handoffs/2026-09-08-fixing-the-2026-09-07-full-audit.ko.md`. §1-4는
> "그럴듯함"이라 적었지만 실제로는 확정된 결함이었다(재현: `shutil.rmtree`가
> 실제로 돎) — 그 문서에서 정정했다.
