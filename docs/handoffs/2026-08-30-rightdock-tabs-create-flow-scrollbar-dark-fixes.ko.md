...
옮겨 두었다. 다섯~열다섯 번째 세션이 남겼던 항목은 전부 닫혔다.

**owner 입력이 있어야 진행되는 것**: 없음. (2026-08-31까지 "실제 로고"가
남아 있었으나 2026-09-01에 owner가 안 해도 된다고 확인해 뺐다.)
...
— 새 화면·기능을 만들 때마다 그 방향을 따르는지 확인하는 식으로 계속
적용된다.
