...
describe("MediaReferenceBadge", () => {
  it("proposal과 timeline reference를 접근 가능한 한국어 label로 구분한다", () => {
    ...
    expect(screen.getByLabelText("유진 추천 12의 비롤 3번")).toBeVisible();
