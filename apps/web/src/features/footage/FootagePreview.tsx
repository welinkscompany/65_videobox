...
type Props = { asset: LibraryAsset | null; previewUrl?: string | null; previewRanges?: Range[]; currentTime: number; duration: number; frameStep: number; onTimeChange: (time: number) => void; onFrameStep: (delta: number) => void; onPreviewError?: () => void };
...
export function FootagePreview({ asset, previewUrl, previewRanges = [], currentTime, duration, frameStep, onTimeChange, onFrameStep, onPreviewError }: Props) {
