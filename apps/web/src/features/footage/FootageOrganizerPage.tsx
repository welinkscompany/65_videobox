...
import { api, type FootageProposal, type FootageProposalPreview, type FootageSegment, type FootageSequence, type LibraryAsset, type YujinFootageInterpretation } from "../../api";
...
export function FootageOrganizerPage() {
  ...
  function selectAsset(asset: LibraryAsset) { setSelectedAsset(asset); setProposal(null); setProposalPreview(null); setYujinCandidate(null); setPreviewUnavailable(false); setSequence(null); setSelectedSequenceItemId(null); setSelectedSegmentId(null); setSelectedSegmentIds([]); setPlayhead(0); setNotice(null); }
