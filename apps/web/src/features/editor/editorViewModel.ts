...
export type EditorViewModel = Readonly<{
  ...
  captions: ReadonlyArray<Readonly<{ segmentId: string; owningSegmentId?: string; captionId?: string; placementId?: string; text: string; startSec: number; endSec: number; style: EditorCaptionStyle }>>;
