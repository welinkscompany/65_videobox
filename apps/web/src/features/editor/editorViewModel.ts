...
export type EditorViewModel = Readonly<{
  ...
  tracks: ReadonlyArray<Readonly<{ trackId: string; role: "narration" | "broll" | "bgm" | "sfx" | "overlay"; clips: ReadonlyArray<Readonly<{ clipId: string; segmentId: string; type: "narration" | "broll" | "bgm" | "sfx" | "overlay"; assetId: string | null; assetUri: string | null; startSec: number; endSec: number; controls: EditorControls; expectedContentSha256?: string | null; mediaRevision?: string | null; overlayType?: "explanation_card" | "image_overlay" | "table_overlay" | null; overlayPayload?: Record<string, unknown> }>> }>>;
