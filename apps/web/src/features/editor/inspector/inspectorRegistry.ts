...
type MediaField = "fadeInSec" | "fadeOutSec" | "inSec" | "outSec" | "speed" | "volume" | "ducking" | "preserveSourceAudio" | "gainDb" | "filter" | "fit" | "normalizeLoudness" | "denoise" | "stabilize" | "preservePitch" | "zoom" | "positionXPercent" | "positionYPercent" | "rotationDeg";
...
const brollFields = ["inSec", "outSec", "speed", "volume", "preserveSourceAudio", "fadeInSec", "fadeOutSec", "filter", "fit", "stabilize", "preservePitch", "zoom", "positionXPercent", "positionYPercent", "rotationDeg"] as const;
