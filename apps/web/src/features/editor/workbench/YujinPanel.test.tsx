...
/** 추천 후보는 2026-08-30 후속으로 이 대화 로그 안으로 들어왔다(owner:
 *  "캡컷도 화면공간이 필요해서 버튼들을 엄청 작게 만들었어. 그래서 나도
 *  캡컷을 벤치마킹하라고 한거잖아" -- 캡컷 EditPilot은 제안 카드를 대화
 *  안에 둔다, 별도 탭이 아니다). 예전엔 `RightDock`의 "추천" 탭이었다. */
describe("추천 후보", () => {
  ...
  it("preserves the selected candidate across an unrelated rerender", () => {
