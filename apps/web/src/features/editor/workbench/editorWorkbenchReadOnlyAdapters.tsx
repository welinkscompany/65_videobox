...
export function EditorWorkbenchReadOnlyAdapters({ view, dock }: { view: EditorViewModel; dock: "left" | "right" }) {
  if (dock === "left") return <>
  ...
  return <>
    <section aria-label="유진" className="vb-editor-workbench__summary"><h2>유진</h2><label htmlFor="vb-eugene-request">유진에게 요청하기</label><textarea id="vb-eugene-request" disabled placeholder="다음 단계에서 사용할 수 있어요." /><button type="button" disabled>요청 보내기</button></section>
