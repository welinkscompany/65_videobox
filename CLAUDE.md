...
| **최신 세션 인계** | `docs/handoffs/2026-08-29-videobox-comfyui-live-test-and-capcut-dark-theme-handoff.ko.md` |
...
- `2026-08-29-ai-video-naming-and-packaging-followups.ko.md` — **AI 영상 생성은
  로컬 비디오 모델(ComfyUI 확장)로 간다**(구현은 아직 미착수, 방향만 승인).
  설치형은 **보류 유지**(위 문서와 동일). "미디어" 이름 충돌은 **전체 메뉴(공용
  라이브러리)만 "자료실"로** — 프로젝트 단계·편집기 도크의 "미디어"는 그대로.
- `2026-08-29-capcut-full-structure-and-dark-theme.ko.md` — **현행 팔레트는 다크다**
  (`2026-08-21-editor-back-to-light`를 되돌림, 2026-08-29에 코드로 구현·검증 완료).
  **메뉴·배치를 캡컷과 끝까지 동일화**
