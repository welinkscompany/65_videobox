...
| **최신 세션 인계** | `docs/handoffs/2026-08-18-videobox-editor-scrub-follow-and-height-persist.ko.md` |
...
- **2026-08-16 확장 승인:** 넓어진 것은 **편집 앞뒤**(대본·업로드·분석)뿐이고 위 경계는
  그대로다. 사람 게이트 셋(제목 선택·대본 확정·업로드)을 없애지 않는다. → `decisions/2026-08-16-autonomous-creator-loop-scope-expansion.ko.md`
